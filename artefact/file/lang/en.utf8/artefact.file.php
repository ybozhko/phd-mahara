...
$string['nosupport'] = 'Fragments of files with this extension are not supported. Currently we support following extensions: <br/> Images: <strong>.jpeg/jpg, .gif, .png</strong>; <br/> Video: <strong>.ogv, .ogg, .mp4, .mkv, .3gp</strong>; <br/> Text: <strong>.txt</strong>';
